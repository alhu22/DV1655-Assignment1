...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // statement_list
      // variables
      char dummy3[sizeof (std::list<Node*>)];
    ...
    SYSTEM_OUT_PRINTLN = 258,      // SYSTEM_OUT_PRINTLN
    WHILE = 259,                   // WHILE
    PUBLIC = 260,                  // PUBLIC
    CLASS = 261,                   // CLASS
    VOID = 262,                    // VOID
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_SYSTEM_OUT_PRINTLN = 3,                // SYSTEM_OUT_PRINTLN
        S_WHILE = 4,                             // WHILE
        S_PUBLIC = 5,                            // PUBLIC
        S_CLASS = 6,                             // CLASS
        S_VOID = 7,                              // VOID
        ...
        S_MAIN = 36,                             // MAIN
        S_STRING = 37,                           // STRING
        S_INTIGER = 38,                          // INTIGER
        S_PLUSOP = 39,                           // PLUSOP
        S_MINUSOP = 40,                          // MINUSOP
        S_MULTOP = 41,                           // MULTOP
        S_INT = 42,                              // INT
        S_LP = 43,                               // LP
        S_RP = 44,                               // RP
        ...
        S_root = 47,                             // root
        S_Goal = 48,                             // Goal
        S_ClassDeclaration_list = 49,            // ClassDeclaration_list
        S_Type = 50,                             // Type
        S_lineno = 51,                           // lineno
        ...
        S_parameter_sequence = 59,               // parameter_sequence
        S_expression = 60,                       // expression
        S_expression_list = 61,                  // expression_list
        S_expression_sequence = 62,              // expression_sequence
        S_MethodDeclaration_list = 63,           // MethodDeclaration_list
        S_statement_list = 64,                   // statement_list
        S_VarDeclaration = 65,                   // VarDeclaration
        S_variables = 66,                        // variables
        S_factor = 67                            // factor
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_PRIVATE (std::string v)
      {
        return symbol_type (token::PRIVATE, std::move (v));
      }
#else
      static
      symbol_type
      make_PRIVATE (const std::string& v)
      {
        return symbol_type (token::PRIVATE, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_INTIGER (std::string v)
      {
        return symbol_type (token::INTIGER, std::move (v));
      }
#else
      static
      symbol_type
      make_INTIGER (const std::string& v)
      {
        return symbol_type (token::INTIGER, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
