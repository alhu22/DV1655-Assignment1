  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_Methodbody = 55,                       // Methodbody
        S_parameter = 56,                        // parameter
        S_parameter_list = 57,                   // parameter_list
        S_parameter_sequence = 58,               // parameter_sequence
        S_expression = 59,                       // expression
        S_expression_list = 60,                  // expression_list
        S_expression_sequence = 61,              // expression_sequence
        S_MethodDeclaration_list = 62,           // MethodDeclaration_list
        S_statement_list = 63,                   // statement_list
        S_VarDeclaration = 64,                   // VarDeclaration
        S_variables = 65,                        // variables
        S_factor = 66                            // factor
      };
    };
