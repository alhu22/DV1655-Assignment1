...
#undef YYCASE_
  ...
  {
  "\"end of file\"", "error", "\"invalid token\"", "WHILE", "PUBLIC",
  "CLASS", "VOID", "RETURN", "STATIC", "IF", "ELSE", "FOR", "NEW", "THIS",
  "TRUE", "FALSE", "NULL", "PLUSOP", "MINUSOP", "MULTOP", "INT", "LP",
  "RP", "$accept", "root", "expression", "factor", YY_NULLPTR
  };
#endif
