...
#line 133 "parser.yy"
        ...
        paramNode->children.push_back(new Node("String[]",yystack_[5].value.as < std::string > (), yylineno));
...
#line 169 "parser.yy"
        ...
        returnStat->children.push_back(yystack_[2].value.as < Node * > ());
        yylhs.value.as < Node * > ()->children.push_back(returnStat);
...
#line 197 "parser.yy"
        ...
        yylhs.value.as < Node * > ()->children.push_back(new Node(yystack_[1].value.as < std::string > (), yystack_[0].value.as < std::string > (), yylineno));
    }
...
#line 222 "parser.yy"
                                         { 
                            yylhs.value.as < Node * > () = new Node("PLUSExpression", "+", yylineno);
...
#line 334 "parser.yy"
        ...
        yylhs.value.as < Node * > ()->children.push_back(new Node(yystack_[2].value.as < std::string > (), yystack_[1].value.as < std::string > (), yylineno));
...
#undef YYCASE_
  ...
  parser::yyrline_[] =
  {
     ...
     169,   185,   186,   190,   197,   204,   208,   215,   216,   222,
     227,   232,   237,   242,   247,   252,   257,   262,   267,   271,
     280,   285,   290,   294,   298,   305,   306,   312,   315,   323,
     327,   334,   343,   346,   352,   353,   354,   355,   359,   363,
     364,   365
  };
